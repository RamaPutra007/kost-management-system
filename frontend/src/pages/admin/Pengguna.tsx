...
const DUMMY_USERS = [
  { id: 1, name: 'Budi Santoso', email: 'budi@example.com', role: 'Owner', status: 'Aktif', joined: '12 Jan 2026' },
  { id: 2, name: 'Siti Aminah', email: 'siti@example.com', role: 'Admin', status: 'Aktif', joined: '15 Feb 2026' },
  { id: 3, name: 'Andi Wijaya', email: 'andi@example.com', role: 'Penghuni', status: 'Aktif', joined: '01 Mar 2026' },
  { id: 4, name: 'Rina Melati', email: 'rina@example.com', role: 'Penghuni', status: 'Nonaktif', joined: '20 Mar 2026' },
  { id: 5, name: 'Joko Anwar', email: 'joko@example.com', role: 'Admin', status: 'Aktif', joined: '05 Apr 2026' },
];
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="p-4 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-2 text-sm text-slate-500 font-medium">
            <span>Total: {DUMMY_USERS.length} Pengguna</span>
          </div>
        </div>
                  ...
                  <tr key={user.id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      <Dropdown
                        ...
                        items={[
                          { label: 'Edit Profil', icon: <Edit2 className="w-4 h-4 mr-2" />, onClick: () => {} },
                          { label: 'Reset Password', icon: <Key className="w-4 h-4 mr-2" />, onClick: () => {} },
                          { label: 'Hapus Akses', icon: <Trash2 className="w-4 h-4 mr-2" />, danger: true, onClick: () => {} },
                        ]}
                      />
                    </td>
                  </tr>
